...
if __name__ == "__main__":
    ...
    for y in range(n_col):
        ...
        line.extend_bottom((0,y_bot))
        line.extend_bottom((side//2,y_bot))
        line.extend_top((0,y_top))
        ...
        y_bot     = height + y_top
        line.extend_bottom((side//2 + x*side,y_bot))
        line.extend_bottom((n_col*side-1,y_bot))
        line.extend_top((side//2 + x*side,y_top))
        line.extend_top((n_col*side-1,y_top))
        line.extend( line.top )
        line.extend([(n_col*side-1,y_top), (n_col*side-1,y_bot)])
        line.extend( line.bottom[::-1] )
        line.draw( draw )
